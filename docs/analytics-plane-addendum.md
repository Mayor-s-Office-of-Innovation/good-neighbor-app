...
*DynamoDB planning set (doc 3 of 5) · [index](./README.md) · ← [data model](./dynamodb-data-model.md) · next → [local-dev plan](./local-dev-environment-plan.md)*
...
- **To feel Tier 2 (export → Athena):** deploy to the **cloud dev account via Terraform in
  CI**, per the [local-dev plan](./local-dev-environment-plan.md)'s local/cloud split. This is
